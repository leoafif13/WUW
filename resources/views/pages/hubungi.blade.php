<section id="hubungi" class="bg-gradient-to-r from-blue-900 to-black min-h-screen scroll-mt-24">
  <div class="max-w-7xl mx-auto px-4 pt-16 pb-16">
    <div class="text-center mb-8 px-2 sm:px-6 lg:px-0">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start px-2 sm:px-8 md:px-12 lg:px-16 py-10">
      <!-- Kontak dan Jam -->
      <div class="space-y-6 text-gray-800">
        ...
        <div class="flex flex-col md:flex-row gap-6">
          ...
          <div class="flex-1 text-white text-sm leading-relaxed p-4 rounded-lg">
            ...
            <p class="flex items-center"><i class="fa-solid fa-phone-volume p-2"></i><strong>Nomor Telepon:</strong> (0778) 456880</p>
            <p class="flex items-center"><i class="fa-solid fa-location-dot p-2"></i><strong>Alamat:</strong> Jl. Ahmad Yani, Tlk. Tering, Kec. Batam Kota, Kota Batam, Kepulauan Riau 29444</p>
            <p class="flex items-center"><i class="fa-regular fa-envelope p-2"></i><strong>Email:</strong> WearYouWant@gmail.com</p>
          </div>
        </div>

        <!-- Iframe Google Maps tetap di bawah -->
        <iframe
          class="w-full rounded-lg shadow mt-4"
          height="220"
