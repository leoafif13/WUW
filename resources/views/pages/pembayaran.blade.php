...
<main class="bg-white text-gray-800 font-sans" x-data>
  ...
  <form action="{{ route('pembayaran.store') }}" method="POST">
    ...
    <div class="p-4 space-y-6 pb-16">
            ...
            <div class="flex-1 min-w-0">
              ...
              <div class="flex flex-col sm:flex-row sm:space-x-2 mt-1 space-y-2 sm:space-y-0">
                <div class="relative w-full sm:w-auto">
                  <select disabled class="w-full sm:w-auto text-sm px-3 py-1 pr-8 rounded-lg bg-gray-200 text-gray-700 appearance-none">
      ...
      <!-- Opsi Pengiriman -->
      <section x-data="{ pengiriman: 'antar' }" class="space-y-2">
        ...
        <div x-show="pengiriman === 'antar'" x-transition x-cloak class="transition-all duration-300 ease-in-out mt-3">
        ...
        <div class="flex justify-between items-start">
          ...
          <div class="relative w-full sm:w-auto">
            ...
            <div x-show="open"
              ...
              <label class="flex items-center space-x-2">
                <input type="radio" name="metode" value="qris" x-model="metode" class="form-radio text-blue-900">
                <span>QRIS</span>
              </label>
            </div>
          </div>
      ...
      <section class="pt-4 space-y-2">
        ...
        <div class="flex justify-between font-semibold text-lg pt-2">
          <span>Total Pembayaran</span><span class="text-blue-900">Rp{{ number_format($subtotalProduk + 1500, 0, ',', '.') }}</span>
        </div>
      </section>
    </div>
    ...
    <footer class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-md flex flex-col sm:flex-row justify-between items-center px-4 py-3 gap-2 sm:gap-0">
      <p class="font-semibold text-sm">
        Total Pembayaran <span class="text-blue-900">Rp{{ number_format($subtotalProduk + 1500, 0, ',', '.') }}</span>
      </p>
      <button type="submit"
