...
<div class="min-h-screen bg-gray-100 p-4">
    <!-- Header -->
    <div class="bg-blue-900 text-white text-center py-4 rounded-b-xl shadow">
        <h1 class="text-lg font-semibold">Nilai Produk</h1>
    </div>

    <!-- Card Produk -->
    <div class="bg-white mt-4 p-4 rounded-xl shadow-md flex gap-4">
        <img src="{{ asset('img/Jas.jpg') }}" alt="Foto Produk" class="w-24 h-28 object-cover rounded-lg">
        <div>
    ...
    <!-- Upload Foto -->
    <div class="mt-6">
        <label for="foto" class="block text-base font-semibold mb-1">Masukkan Foto</label>
