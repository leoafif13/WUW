<html lang="en">
 ...
 <body>
  ...
  <img src="img/bg.png" alt="Background image" class="absolute inset-0 w-full h-full object-cover opacity-40" loading="lazy" aria-hidden="true" />
  <div class="relative z-10 mt-20 md:mt-28 flex flex-col items-center">
   ...
   <form autocomplete="off" class="relative z-10 bg-white bg-opacity-90 rounded-md w-[90vw] max-w-3xl p-4 md:p-6 mb-12">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
     <div>
      <label class="block text-[13px] font-semibold text-[#5a0a0a] mb-1" for="namaLengkap">
       Nama Lengkap
      </label>
     ...
     <div>
      <label class="block text-[13px] font-semibold text-[#5a0a0a] mb-1" for="namaPengguna">
       Nama Pengguna
      </label>
     ...
     <div>
      <label class="block text-[13px] font-semibold text-[#5a0a0a] mb-1" for="alamatEmail">
       Alamat Email
      </label>
     ...
     <div>
      <label class="block text-[13px] font-semibold text-[#5a0a0a] mb-1" for="nomorTelepon">
       Nomor Telepon
      </label>
     ...
     <div>
      <label class="block text-[13px] font-semibold text-[#5a0a0a] mb-1" for="kataSandi">
       Kata Sandi
      </label>
     ...
     <div>
      <label class="block text-[13px] font-semibold text-[#5a0a0a] mb-1" for="konfirmasiKataSandi">
    ...
    <button class="mt-3 w-full bg-[#5a0a0a] text-white text-[13px] font-semibold py-2 rounded-sm hover:bg-[#4a0808] transition-colors" type="submit">
     Buat Akun
    </button>
